...
@section('content')
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
			<p class="alert alert-warning"><strong><i class="fa fa-warning"></i> This app has been built by <a target="_blank" href="http://twitter.com">@</a> for learning purposes.</strong></p>
			</div>
		</div>
